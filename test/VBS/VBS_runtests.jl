...
@testset "KAPDQMC.jl" begin
    ...
    model = VBS_Hubbard_Para(SUN=3, Ht=1.0, HJ1=4.0, HJ2=4.0,
        Θrelax=5.0, Θquench=0., Lattice="HoneyComb120",
        site=[9, 9], Δt=0.05, BatchSize=10, Initial="VBS")
    ...
    # L = model.site[2]
    # indexA = area_index(model.Lattice, model.site, ([1, 1], [L, div(L, 3)]))
    # # # HalfHalf
