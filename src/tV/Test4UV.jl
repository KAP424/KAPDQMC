...
sp = Random.Sampler(MersenneTwister(1234), [1, 2, 3, 4])
for i in eachindex(s)
    s[i] = rand(MersenneTwister(1234), sp)
end
...
idx_bond=1
x_idx=2
ss[x_idx, idx_bond, lt] = rand(MersenneTwister(1234), model.samplers_dict[s[x_idx, idx_bond, lt]])
